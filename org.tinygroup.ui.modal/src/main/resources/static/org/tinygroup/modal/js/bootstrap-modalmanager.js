	...
	* ====================== */
	...
	ModalManager.prototype = {
		...
		appendModal: function (modal) {
			...
			modal.$element.on('show.modalmanager', targetIsSelf(function (e) {
				...
				var showModal = function(){
					...
					that.$element.toggleClass('page-overflow', $(window).height() < that.$element.height()).toggleClass('modal-open', that.hasOpenModal())
		...
		loading: function (callback) {
			...
			this.$element.toggleClass('page-overflow', $(window).height() < this.$element.height()).toggleClass('modal-open', !this.isLoading || this.hasOpenModal())
