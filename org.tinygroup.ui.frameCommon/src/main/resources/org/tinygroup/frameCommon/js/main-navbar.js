...
(function() {
  ...
  TinyAdmin.MainNavbar.prototype.init = function() {
    var is_mobile;
  ...
  TinyAdmin.MainNavbar.prototype._setupScroller = function() {
    if (this._scroller) {
      return;
    }
    this._scroller = true;
  ...
  TinyAdmin.MainNavbar.prototype._removeScroller = function() {
    if (!this._scroller) {
      return;
    }
    this._wheight = null;
  ...
  TinyAdmin.MainNavbar.prototype._updateCollapseHeight = function() {
  ...
  TinyAdmin.MainNavbar.prototype._watchWindowHeight = function() {
  ...
  TinyAdmin.MainNavbar.Constructor = TinyAdmin.MainNavbar;

  TinyAdmin.addInitializer(function() {
    return TinyAdmin.initPlugin('main_navbar', new TinyAdmin.MainNavbar);
  });
