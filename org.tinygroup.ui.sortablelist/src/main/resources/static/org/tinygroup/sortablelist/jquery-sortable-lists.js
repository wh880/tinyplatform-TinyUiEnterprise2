...
( function ($) {
    ...
    $.fn.sortableLists = function (options) {
        ...
        var jQBody = $(options.listRap).css('position', 'relative'),
        ...
        return this.on('mousedown', function (e) {
                ...
                if (state.isDragged !== false || ( setting.ignoreClass && target.closest('li').hasClass(setting.ignoreClass) )) return; // setting.ignoreClass is checked cause hasClass('') returns true
        ...
        function startDrag(e, el, rEl) {
            ...
            state.cEl = {
                ...
                offset: {"left": elXY.left - baseXY.left, "top": elXY.top - baseXY.top}
            };
            ...
            el.css({
                'width': el.width(),
                'position': 'absolute',
                'top': state.cEl.offset.top - elMT,
                'left': state.cEl.offset.left - elML
            }).prependTo(base);
        ...
        function endDrag(e) {
            ...
            baseXY = base.offset();
            cEl.el.animate({left: offset.left - baseXY.left - state.cEl.mL, top: offset.top - baseXY.top - state.cEl.mT}, 250,
