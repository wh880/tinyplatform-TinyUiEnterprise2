...
function (a, b) {
    ...
    var Bb = c.pathBBox = function (a) {
            ...
            a = Kb(a);
            for (var c, e = 0, f = 0, g = [], h = [], i = 0, j = a.length; j > i; i++) if (c = a[i], "M" == c[0]) e = c[1],
            f = c[2],
            g.push(e),
            h.push(f);
            else {
            ...
            if (c.svg) {
                ...
                A.attr = function (b, d) {
                        ...
                        if (null == d && c.is(b, "string")) {
                            ...
                            for (var g = b.split(j), h = {}, i = 0, l = g.length; l > i; i++) b = g[i],
                ...
                c.prototype.clear = function () {
                        ...
                        (this.desc = q("desc")).appendChild(c._g.doc.createTextNode("Created with Rapha\xebl " + c.version)),
            ...
            if (c.vml) {
                ...
                E.attr = function (b, d) {
                        ...
                        if (null == d && c.is(b, "string")) {
                            ...
                            for (var g = b.split(k), h = {}, i = 0, m = g.length; m > i; i++) b = g[i],
                            h[b] = b in this.attrs ? this.attrs[b] : c.is(this.paper.customAttributes[b], "function") ? this.paper.customAttributes[b].def : c._availableAttrs[b];
                            return m - 1 ? h : h[g[0]]
                        }
...
function () {
    ...
    b.Grid = function (c) {
            ...
            d.prototype.setData = function (a, c) {
                ...
                return null == c && (c = !0),
                this.options.data = a,
                null == a || 0 === a.length ? (this.data = [], this.raphael.clear(), void(null != this.hover && this.hover.hide())) : (o = this.cumulative ? 0 : null, p = this.cumulative ? 0 : null, this.options.goals.length > 0 && (h = Math.min.apply(Math, this.options.goals), g = Math.max.apply(Math, this.options.goals), p = null != p ? Math.min(p, h) : h, o = null != o ? Math.max(o, g) : g), this.data = function () {
                    var c, d, g;
            ...
            d.prototype.drawGrid = function () {
                ...
                if (this.options.grid !== !1 || (e = this.options.axes) === !0 || "both" === e || "y" === e) {
                    ...
                    h.push(this.options.grid ? this.drawGridLine("M" + this.left + "," + b + "H" + (this.left + this.width)) : void 0);
                    return h
                }
            },
    ...
    b.Line = function (a) {
            function c(a) {
                ...
                this instanceof b.Line ? void c.__super__.constructor.call(this, a) : new b.Line(a)
            }
            return h(c, a),
            ...
            c.prototype.generatePaths = function () {
                ...
                return this.paths = function () {
                    var g, h, j, k;
                    for (k = [], d = g = 0, h = this.options.ykeys.length; h >= 0 ? h > g : g > h; d = h >= 0 ? ++g : --g) f = "boolean" == typeof this.options.smooth ? this.options.smooth : (j = this.options.ykeys[d], i.call(this.options.smooth, j) >= 0),
                    c = function () {
                        var a, b, c, f;
                        for (c = this.data, f = [], a = 0, b = c.length; b > a; a++) e = c[a],
                        void 0 !== e._y[d] && f.push({
                            "x": e._x,
                            "y": e._y[d]
                        });
                        return f
                    }.call(this),
                    this.options.continuousLine && (c = function () {
                        var b, d, e;
                        for (e = [], b = 0, d = c.length; d > b; b++) a = c[b],
                        null !== a.y && e.push(a);
                        return e
                    }()),
    ...
    b.labelSeries = function (c, d, e, f, g) {
            ...
            (o = h.getTime()) <= d;) o >= c && l.push([n.fmt(h), o]),
            n.incr(h);
            return l
        },
    c = function (a) {
    ...
    b.Bar = function (c) {
            ...
            d.prototype.calcBars = function () {
                ...
                g.push(b._y = function () {
                    ...
                    f.push(null != c ? this.transY(c) : null);
                    return f
                }.call(this));
                return g
            },
            ...
            d.prototype.drawSeries = function () {
                ...
                this.bars = function () {
                    ...
                    q.push(function () {
                        ...
                        null !== n ? (o ? (m = Math.min(n, o), b = Math.max(n, o)) : (m = n, b = this.bottom), f = this.left + d * c + g, this.options.stacked || (f += j * (a + this.options.barGap)), k = b - m, this.options.stacked && (m -= e), this.drawBar(f, m, a, k, this.colorFor(i, j, "bar"), this.options.barOpacity, this.options.barRadius), q.push(e += k)) : q.push(null);
                        return q
                    }.call(this));
                    return q
                }.call(this)
